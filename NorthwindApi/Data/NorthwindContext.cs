...
public partial class NorthwindContext : DbContext
{
    ...
    // Protected constructor for derived contexts (e.g., NorthwindLazyContext)
    protected NorthwindContext(DbContextOptions options)
        : base(options)
    {
    }
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        ...
        {
            // Fallback only — normally configured via DI in Program.cs
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        // Global query filter: automatically exclude discontinued products
        // Demonstrates HasQueryFilter — used by GlobalFiltersController
